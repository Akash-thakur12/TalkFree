...
/**
 * Minimal Twilio Voice webhook — POST /call returns TwiML to dial `To`.
 *
 * Run: npm install && PORT=3000 node index.js
 * Env: TWILIO_CALLER_ID (optional, E.164 — used as <Dial callerId>)
 */
...
/** Normalize to E.164: + and digits only. Returns null if unusable. */
function toE164(raw) {
